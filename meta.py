...
market_cap = 1500  # billion
current_revenue = 150  # billion (TTM)
current_fcf = 43  # billion (FY 2023)
cash = 42  # billion
debt = 0  # billion
...
base_case_growth = [0.22, 0.16, 0.14, 0.13, 0.12, 0.11, 0.10, 0.09, 0.08, 0.07]
optimistic_case_growth = [0.24, 0.18, 0.16, 0.15, 0.14, 0.13, 0.12, 0.11, 0.10, 0.09]
pessimistic_case_growth = [0.20, 0.14, 0.12, 0.11, 0.10, 0.09, 0.08, 0.07, 0.06, 0.05]
